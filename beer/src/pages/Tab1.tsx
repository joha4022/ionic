          ...
          <IonContent fullscreen>
            <IonGrid>
              ...
              <IonRow>
                ...
                <IonCol data-type={tab1[1].brewery_type} id='1'>{tab1[1].name}</IonCol>
              </IonRow>
              <IonRow>
                <IonCol data-type={tab1[2].brewery_type} id='2'>{tab1[2].name}</IonCol>
                <IonCol data-type={tab1[3].brewery_type} id='3'>{tab1[3].name}</IonCol>
              </IonRow>
              <IonRow>
                <IonCol data-type={tab1[4].brewery_type} id='4'>{tab1[4].name}</IonCol>
                <IonCol data-type={tab1[5].brewery_type} id='5'>{tab1[5].name}</IonCol>
              </IonRow>
            </IonGrid>
        </IonContent>
      </IonPage>
